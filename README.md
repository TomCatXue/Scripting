...
| 脚本 | 说明 | 尺寸 | 订阅链接 |
|---|---|---|---|
| [F50 Widget](./F50%20Widget) | ZTE F50（UFI-TOOLS）网络状态小组件：今日/本月流量、信号、电池、CPU、内存、Wi-Fi；应用内置设置页（URL/密码配置、测试连接），支持点击刷新与离线缓存 | Small / Medium / Large | `https://github.com/TomCatXue/Scripting/tree/main/F50%20Widget` |
